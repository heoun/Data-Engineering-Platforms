...
CREATE TABLE IF NOT EXIST `access`(
    ...
    `State` VARCHAR(255) NOT NULL,
    `County` VARCHAR(255) NOT NULL,
    `LACCESS_POP10` INT(11) NULL,
    `LACCESS_POP15` INT(11) NULL,
    `PCH_LACCESS_POP_10_15` INT(11) NULL,
    `PCT_LACCESS_POP10` INT(11) NULL,
    `PCT_LACCESS_POP15` INT(11) NULL,
    `LACCESS_LOWI10` INT(11) NULL,
    `LACCESS_LOWI15` INT(11) NULL,
    `PCH_LACCESS_LOWI_10_15` INT(11) NULL,
    `PCT_LACCESS_LOWI10` INT(11) NULL,
    `PCT_LACCESS_LOWI15` INT(11) NULL,
    `LACCESS_HHNV10` INT(11) NULL,
    `LACCESS_HHNV15` INT(11) NULL,
    `PCH_LACCESS_HHNV_10_15` INT(11) NULL,
    `PCT_LACCESS_HHNV10` INT(11) NULL,
    `PCT_LACCESS_HHNV15` INT(11) NULL,
    `LACCESS_SNAP15` INT(11) NULL,
    `PCT_LACCESS_SNAP15` INT(11) NULL,
    `LACCESS_CHILD10` INT(11) NULL,
    `LACCESS_CHILD15` INT(11) NULL,
    `PCT_LACCESS_CHILD_10_15` INT(11) NULL,
    `PCT_LACCESS_CHILD10` INT(11) NULL,
    `PCT_LACCESS_CHILD15` INT(11) NULL,
    `LACCESS_SENIORS10` INT(11) NULL,
    `LACCESS_SENIORS15` INT(11) NULL,
    `PCH_LACCESS_SENIORS_10_15` INT(11) NULL,
    `PCT_LACCESS_SENIORS10` INT(11) NULL,
    `PCT_LACCESS_SENIORS15` INT(11) NULL,
    `LACCESS_WHITE15` INT(11) NULL,
    `PCT_LACCESS_WHITE15` INT(11) NULL,
    `LACCESS_BLACK15` INT(11) NULL,
    `PCT_LACCESS_BLACK15` INT(11) NULL,
    `LACCESS_HISP15` INT(11) NULL,
    `PCT_LACCESS_HISP15` INT(11) NULL,
    `LACCESS_NHASIAN15` INT(11) NULL,
    `PCT_LACCESS_NHASIAN15` INT(11) NULL,
    `LACCESS_NHNA15` INT(11) NULL,
    `PCT_LACCESS_NHNA15` INT(11) NULL,
    `LACCESS_NHPI15` INT(11) NULL,
    `PCT_LACCESS_NHPI15` INT(11) NULL,
    `LACCESS_MULTIR15` INT(11) NULL,
    `PCT_LACCESS_MULTIR15` INT(11) NULL,
    PRIMARY KEY (`county_key`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
